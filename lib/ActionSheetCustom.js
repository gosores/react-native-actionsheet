...
class ActionSheet extends React.Component {
  ...
  _createButton (title, index) {
    ...
    let buttonBoxStyle = cancelButtonIndex === index ? styles.cancelButtonBox : styles.buttonBox
    buttonBoxStyle = cancelButtonIndex - 1 === index ? styles.buttonBoxEnd : buttonBoxStyle
    return (
      <TouchableHighlight
        key={index}
        activeOpacity={1}
